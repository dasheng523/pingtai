    ...
    <div class="page page-current" id="collection-info">
        <div class="content">
            ...
            <div class="row content-block">
                <div class="col-33">
                    <a href="javascript:;" class="weui_btn weui_btn_primary">想买</a>
                </div>
                <div class="col-33">
                    <a href="javascript:;" class="weui_btn weui_btn_warn">收藏</a>
                </div>
                <div class="col-33">
                    <a href="javascript:;" class="weui_btn weui_btn_primary">分享</a>
                </div>
            </div>
                        ...
                        <ul>
                            <li class="item-content">
                                <div class="item-inner">
                                    <div class="item-title">东门口何玲米粽</div>
                                </div>
                            </li>
                            <li class="item-content">
                                <div class="item-inner">
                                    <span class="green-text big-text">
