...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__47476__auto__,writer__47477__auto__,opt__47478__auto__){
return cljs.core._write.call(null,writer__47477__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__46878__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__46878__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__46878__auto__)){
return or__46878__auto__;
} else {
...
var G__67551 = o;
(G__67551[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__67552__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__67552 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__67553__i = 0, G__67553__a = new Array(arguments.length -  0);
while (G__67553__i < G__67553__a.length) {G__67553__a[G__67553__i] = arguments[G__67553__i + 0]; ++G__67553__i;}
  args = new cljs.core.IndexedSeq(G__67553__a,0);
} 
return G__67552__delegate.call(this,args);};
G__67552.cljs$lang$maxFixedArity = 0;
G__67552.cljs$lang$applyTo = (function (arglist__67554){
var args = cljs.core.seq(arglist__67554);
return G__67552__delegate(args);
});
...
var old_67555 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_67555))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_67555)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__46866__auto__ = (node === document.activeElement);
if(and__46866__auto__){
var and__46866__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__46866__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__67558 = jsprops;
(G__67558["defaultValue"] = value);

(G__67558["onChange"] = ((function (G__67558,v,value,on_change){
return (function (p1__67556_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__67556_SHARP_);
});})(G__67558,v,value,on_change))
);
...
var vec__67560 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__67560,(0),null);
var id = cljs.core.nth.call(null,vec__67560,(1),null);
var class$ = cljs.core.nth.call(null,vec__67560,(2),null);
...
var temp__4427__auto__ = (function (){var G__67564 = cljs.core.meta.call(null,v);
var G__67564__$1 = (((G__67564 == null))?null:reagent.impl.template.get_key.call(null,G__67564));
return G__67564__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__67566_67567 = v;
var G__67566_67568__$1 = (((G__67566_67567 == null))?null:reagent.impl.template.key_from_vec.call(null,G__67566_67567));
var G__67566_67569__$2 = (((G__67566_67568__$1 == null))?null:(jsprops["key"] = G__67566_67568__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__67572 = cljs.core.meta.call(null,argv);
var G__67572__$1 = (((G__67572 == null))?null:reagent.impl.template.get_key.call(null,G__67572));
return G__67572__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__67573 = (((jsprops == null))?{}:jsprops);
(G__67573["key"] = key);
...
var G__67574 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__67574;
continue;
}
} else {
...
var n__47781__auto___67575 = a.length;
var i_67576 = (0);
while(true){
if((i_67576 < n__47781__auto___67575)){
(a[i_67576] = reagent.impl.template.as_element.call(null,(a[i_67576])));

var G__67577 = (i_67576 + (1));
i_67576 = G__67577;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__47781__auto___67578 = a.length;
var i_67579 = (0);
while(true){
if((i_67579 < n__47781__auto___67578)){
var val_67580 = (a[i_67579]);
if((cljs.core.vector_QMARK_.call(null,val_67580)) && ((reagent.impl.template.key_from_vec.call(null,val_67580) == null))){
(o["no-key"] = true);
} else {
}

(a[i_67579] = reagent.impl.template.as_element.call(null,val_67580));

var G__67581 = (i_67579 + (1));
i_67579 = G__67581;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__46866__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__46866__auto__){
return (ctx["no-key"]);
} else {
return and__46866__auto__;
...
var G__67583 = (cljs.core.count.call(null,argv) - first_child);
switch (G__67583) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__67583){
